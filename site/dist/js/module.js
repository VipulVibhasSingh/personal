...
exports.default = {
    ...
    more: [{
        ...
        questions: ['Who won the NME Award for worst Band in 2013', 'What band separated in 2014', 'What is the worst band of all time?', 'Which band you hate the most?', 'What band released seven albums?', 'Which band is is 12 years old?', 'Who built Rome in 7 days?', 'Which band was caught in a bomb blast?', 'Which band was killed by Batman(ME)?', 'What is the name of band I was a part of?']
    }, {
        answer: 'Atlas Corrigan',
        questions: ['Who is your most talked of fictional character?', 'Who do I remind you of?', 'Who sang ‘Gangnam Style’?', 'Who painted the ‘Mona Lisa’?', 'Who has a vertical height of 9 feet?', 'Which character lives in Antarctica', 'What is the  definition of a nigga?', 'What is Godrick\'s real name?', 'Who hates Lily Bloom?']
    }, {
        answer: '"A"',
        questions: ['What makes you always right?', 'What is the 4th character of "Alphabet"?', 'Which team\'s mascot is an eagle?', 'What is the most used English Alphabet?', 'Which alphabets is the starting character of most words?', 'What Character means "5"’?', 'What is the least used character in our chats?', 'What character uses a title ?']
    }, {
        answer: 'My Pagalpanti(Bakwass)',
        questions: ['What is the one thing you\'ll never understand?', 'What do you hate the most?', 'What makes me defective?', 'What is the one thing you want to change about me?', 'What letter comes after ‘S’?', 'What makes me Intelligent?', 'What makes you happy?']
    }, {
        answer: 'Best Feeling Ever',
        questions: ['When I can<br/>touch and hug you?', 'When you ordered Jacket Potato?', 'When you forgot you called me <br/>the BESTIE?', 'When you run away from me?', 'When you get dead suddenly in a random awkward position?', 'When its raining in Bangalore?']
    }, {
        answer: 'Playboy',
        questions: ['Whom do you love the most?', 'Which type of person you hate the most?', 'What does PM Modi tattoo say?', 'What rapper is on Drake\'s ass?', 'What is my second nickname?']
    }, {
        answer: 'Better than words',
        questions: ['What is the caption of my first post with you?', 'How you feel about my voice?', 'What does Sawan said while doing drugs?', 'What is your favourite diaologue?']
    }, {
        answer: 'IBIS, Bengaluru',
        questions: ['Where did we meet?', 'Madame ji, where\’s my bike?', 'Where have all the racists gone?']
    }, {
        answer: 'Five-Six',
        questions: ['How many months have we been together?', 'How old is Sam?']
    }, {
        answer: 'YES!',
        questions: ['Shanaaya,<br/>will you officially<br/>become my <br />forever Valentines?']
    }],
    nextQuestion: function nextQuestion() {
